        ...
        <div className="border  border-input border-t-0 border-x-0 rounded-lg p-2 bg-card flex flex-wrap gap-1 items-center">
            <TooltipProvider>
                ...
                <div className="flex flex-wrap gap-1">
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button onClick={() => editor.chain().focus().undo().run()}size="sm" variant="ghost" type="button" disabled={!editorState?.canUndo}>
                                <Undo/>
                    ...
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <Button onClick={() => editor.chain().focus().redo().run()}size="sm" variant="ghost" type="button" disabled={!editorState?.canRedo}>
                                <Redo/>
